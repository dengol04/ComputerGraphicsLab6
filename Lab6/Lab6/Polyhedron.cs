...
namespace PlatonicSolids
{
    public class Polyhedron
    {
        ...
        public static Polyhedron CreateIcosahedron()
        {
            ...
            var polygons = new List<Polygon>
            {
                new Polygon(new[] {0, 11, 5}), new Polygon(new[] {0, 5, 1}), new Polygon(new[] {0, 1, 7}),
                new Polygon(new[] {0, 7, 10}), new Polygon(new[] {0, 10, 11}),
                new Polygon(new[] {1, 5, 9}), new Polygon(new[] {5, 11, 4}), new Polygon(new[] {11, 10, 2}),
                new Polygon(new[] {10, 7, 6}), new Polygon(new[] {7, 1, 8}),
                new Polygon(new[] {3, 9, 4}), new Polygon(new[] {3, 4, 2}), new Polygon(new[] {3, 2, 6}),
                new Polygon(new[] {3, 6, 8}), new Polygon(new[] {3, 8, 9}),
                new Polygon(new[] {4, 9, 5}), new Polygon(new[] {2, 4, 11}), new Polygon(new[] {6, 2, 10}),
                new Polygon(new[] {8, 6, 7}), new Polygon(new[] {9, 8, 1})
            };
